...
print('Source: https://github.com/GoRyuuO')
...
try:
    ...
    print('"data/msedgedriver.exe" file is missing or is can not be execute')
    print('and make sure MSEdge is installed in your PC.')
...
def get_account():
    global USER, PSWD 
    print('\n=================================')
    USER = input('PSU-Passport username: ')
    PSWD = getpass.getpass('PSU-Passport password: ')
    print('=================================\n')
